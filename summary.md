...
汇总第 1–14 课出现的生词与短语（≤3 词），**按词根聚合**、去重。

**读法**

- 每个词根家族：**加粗**的是词根 / 主词条，下面 `↳` 是派生词或同族词。
...
| **alam** | 自然；世界 | — |
| ↳ mengalami | 经历；遭遇 | Seluruh Indonesia mengalami bencana (L10) |
| ↳ pengalaman | 经验；经历 | Aku akan berbagi pengalaman pribadiku (L6) |
| ↳ bencana alam | 自然灾害 | benar-benar bencana alam, atau akibat perbuatan manusia (L10) |
| **alay** | 土味；做作(俚) | terlalu alay dan terlalu berlebihan (L11) |
| **aman** | 安全 | tapi aman? (L5) |
| ↳ keamanan | 安全(名词) | (L4) |
| ↳ cari aman | 求稳 | banyak Chindo yang lebih memilih untuk cari aman (L6) |
| **ancam** | 威胁 | asap ini mengancam (L10) |
| ↳ mengancam | 威胁(动词) | ancam → mengancam (L10) |
| **angin** | 风 | saya merasa ada angin (L4) |
| ↳ masuk angin | 着凉；受风 | agar tidak masuk angin (L2) |
| ↳ obat tolak angin | 驱风药/感冒药 | (L2) |
| ↳ buang angin | 放屁/打嗝 | (L4) |
| ↳ angin kuat seperti topan | 像台风的强风 | (L7) |
| **anggap** | 认为；当作 | — |
| ↳ menganggap | 认为；把…当作 | tidak sedikit yang menganggap Chindo hebat (L6) |
| **angka** | 数字 | Angka 350 ini agak dilebih-lebihkan (L9) |
| ↳ angka vs nomor vs hitung | 数字/号码/计算 | (L9) |
| **angkutan** | 运输 | — |
...
| **asal** | 起源；来源 | — |
| ↳ asli | 原本的；本地的 | orang yang punya darah asli Indonesia (L6) |
| ↳ berasal dari | 源自 | berasal dari (L3) |
| **asap** | 烟 | Asap juga sampai di negara tetangga (L10) |
| ↳ asap tebal | 浓烟 | (L10) |
| **awal** | 开始；早 | awal bulan ini (L8) |
| ↳ lebih awal | 更早 | perlu datang lebih awal ke bandara (L5) |
| **bahan** | 材料；食材 | mengalami kekurangan bahan makanan (L10) |
...
| ↳ berbeda-beda | 各不相同 | tetap punya sejarah yang berbeda-beda (L9) |
| **bekal** | (随身)便当；干粮 | anak SD yang sedang dibuatkan bekal (L13) |
| **bekas** | 旧的；用过的 | bekas yang kemarin dicuci aja (L12) |
| **belakang** | 后面；背后 | — |
...
| **benar** | 对；真的 | — |
| ↳ benar-benar | 真正地；确实 | benar-benar pernah terjadi (L9/L10) |
| ↳ betul | 对；正确 | betul — benar (L13) |
| ↳ kebetulan | 恰巧；碰巧 | kebetulan sekarang aku lagi baca… (L8/L13) |
| **berangkat** | 出发 | setengah jam sebelum berangkat (L5) |
| **berantem** | 吵架；打架(口) | dengan berantem (L13) |
| ↳ bertengkar | 争吵 | (L13) |
| ↳ rebutan | 抢 | (L13) |
...
| **buyut** | 曾祖(辈)；曾孙(辈) | kakek buyutku (L6) |
| ↳ kakek buyut | 曾祖父 | (L6) |
| **cabe / cabai** | 辣椒 | (L3) |
| **cairan** | 液体 | (L2) |
| **candaan** | 玩笑 | banyak candaan (L11/L12) |
| ↳ lelucon | 笑话 | sebuah lelucon (L11/L12) |
| **capek** | 累 | udah capek ngajar (L14) |
| **cari** | 找 | — |
| ↳ cari tahu | 查明；打听 | saya cari tahu tempat wisata di bali (L8/L9) |
| **centil** | 妖娆；爱俏(仅形容女性) | musik centil kembali terkenal (L11) |
| **cenderung** | 倾向于 | — |
| ↳ kecenderungan | 倾向 | kita punya kecenderungan (L6) |
| **cerita** | 故事 | (L11) |
| ↳ ceritakan | 讲述 | (L6) |
| **cewek** | 女孩(口) | (L11/L13) |
| ↳ cowok | 男孩(口) | cowoknya memanggil si cewek wife (L13) |
| **cinta** | 爱 | cinta itu buta (L8) |
| ↳ cinta monyet | 早恋；小孩子的恋爱 | cinta-cintaan anak kecil (L13) |
| ↳ cinta-cintaan | 谈情说爱 | belum waktunya cinta-cintaan (L13) |
...
| ↳ cukup sering | 挺常 | (L10) |
| **curiga** | 怀疑 | (L13) |
| **dalam** | 里面；深 | kakinya ada luka yang dalam (L12) |
| ↳ pedalaman | 偏远内陆 | masyarakat pedalaman (L9/L10/L12) |
| ↳ orang dalam / ordal | 内部人；有关系的人 | punya ordal sangat penting (L12) |
| ↳ pakaian dalam / dalaman | 内衣 | Celana dalam, CD (L12) |
| ↳ mendalami / memperdalam | 钻研；加深 | memperdalam suatu ilmu (L12) |
| **dampak** | 影响；冲击 | dampak kebakaran ini (L10) |
| ↳ dampak negatif / positif | 负面/正面影响 | (L10) |
| **dandanan** | 打扮；妆容 | dandanan dan cara pakaian (L11) |
| **dangdut** | (印尼)当独舞曲 | dangdut Indonesia yang jedag-jedug (L11) |
| ↳ hip-dut | hip-hop + dangdut | (L11) |
| **daring** | 在线(= dalam jaringan) | (L2) |
| **demo** | 示威游行 | demo di indonesia (L9/L14) |
| **deras** | (雨)大 | hujan deras (L2) |
| **dengar** | 听 | — |
| ↳ mendengar(kan) | 听；聆听 | mendengarkan musik (L2) |
| ↳ kedengaran | 听起来 | kedengaran rasis (L6) |
| ↳ terdengar | 被听到 | (L2) |
| **desa** | 村庄 | desa wisata (L8) |
...
| ↳ lagu galau | 伤感歌 | (L11) |
| **garing** | 脆 | (L3) |
| ↳ lembek vs garing | 软 vs 脆 | (L3) |
| **gaul** | 交际；潮(俚) | bahasa gaul (L7) |
| ↳ bahasa gaul | 俚语；网络流行语 | (L7) |
| ↳ pergaulan | 社交；交际 | pergaulanku baik-baik saja (L6) |
| **gaya** | 风格；样式 | gaya: style (L11) |
| **gelas** | 玻璃杯 | Martabak mi gelas (L13) |
| **geli** | 肉麻；发痒 | Lucu tapi geli banget (L13) |
| ↳ gatal | 痒 | (L13) |
| **gemas** | 萌得心痒 | (L7) |
...
| ↳ teh tawar | 无糖茶 | (L11) |
| **hasil** | 成果；结果 | (L14) |
| ↳ menghasilkan | 产生；赚(钱) | menghasilkan uang (L14) |
| ↳ penghasilan | 收入 | sumber penghasilan utama (L14) |
| **hebat** | 厉害；了不起 | menganggap Chindo hebat-hebat (L6/L8) |
| **hewan** | 动物 | binatang vs hewan (L9/L10) |
| ↳ binatang | 动物 | binatang peliharaan (L10) |
| ↳ satwa liar | 野生动物 | (L10) |
| ↳ anabul (anak bulu) | 毛孩子(宠物) | (L10) |
| ↳ peliharaan | 宠物；饲养的 | binatang peliharaan (L10) |
...
| ↳ ikut pertemuan/konferensi | 参加会议 | (L7) |
| **ilmu** | 学问；学科 | ilmu vs pengetahuan (L9) |
...
| ↳ terjadi | 发生 | benar-benar pernah terjadi (L3/L9) |
| ↳ kejadian | 事件 | satu kejadian yang tersembunyi (L7/L9) |
| **jajah** | 殖民 | masa penjajahan (L9) |
| ↳ penjajahan | 殖民(时期) | sebelum Indonesia merdeka (L9) |
| **jarang** | 很少 | jarang ditemukan (L2/L11) |
| **jauh** | 远 | cukup jauh (L5) |
| ↳ jauh sebelum | 远早于 | (L9) |
| **jedag-jedug** | 咚呲哒(节拍拟声) | (L11) |
| **berjuang** | 奋斗；拼搏 | berjuang (L14) |
...
| ↳ kejut | 惊吓 | (L13) |
| **kaki** | 脚 | mata kaki (L8) |
| ↳ mata kaki | 脚踝 | banjir setinggi mata kaki (L8) |
...
| ↳ kata / bicara / bilang / sebut | 词/说话/说/提及 | (L4) |
| **kawasan** | 地区；区域 | (L14) |
...
| ↳ kebun sawit | 棕榈园 | kebun sawit = palm oil plantation (L10) |
| ↳ kelapa sawit | 油棕 | (L10) |
| ↳ sawah | 稻田 | (L10) |
...
| ↳ berkembang | 发展；成长 | (L14) |
| **kemerdekaan** | 独立 | hari kemerdekaan (L8/L9) |
| ↳ merdeka | 独立(自由) | sebelum Indonesia merdeka (L9) |
| **kena** | 遭遇；碰到 | kena marah (L4) |
| ↳ terkena | 遭受 | terkena infeksi (L10) |
| ↳ kena pukul | 挨打 | (L4) |
| **kenal** | 认识 | mereka belum mengenal satu sama lain (L14) |
| ↳ berkenalan | 结识；相识 | berkenalan (L14) |
| ↳ mengenal / mengenalkan | 认识 / 介绍 | (L14) |
| ↳ terkenal | 著名；出名 | (L6/L14) |
...
| ↳ kulineran | 美食探店 | (L14) |
| **kurang** | 缺；少 | — |
| ↳ kurang lebih | 差不多 | (L5/L6) |
| ↳ kekurangan | 短缺；不足 | mengalami kekurangan bahan makanan (L10) |
| **lagu** | 歌 | jenis lagu (L11/L12) |
| **lahan** | 土地 | Kebakaran hutan dan lahan (L10) |
| **lahir** | 出生 | keturunan Tionghoa yang lahir di Indonesia (L6) |
| **lama** | 久 | — |
| ↳ lambat | 慢 | lama = 久, lambat = 慢 (L2) |
| ↳ dilihat lama-lama | 看久了 | dilihat lama-lama jadi lucu (L7) |
| **lancar** | 流利；顺畅 | bahasa Indonesianya sudah lancar (L6) |
...
| **mabuk** | 醉 | orang yang mabuk karena alkohol (L7) |
| **main** | 玩 | main alat musik (L1) |
| ↳ permainan | 游戏；项目 | main 1 permainan (L7) |
| **makna** | 涵义 | arti / maksud / makna (L12) |
| ↳ maksud / maksudnya | 意思；意图 | Maksudnya (L11) |
| **malah** | 反而 | malah bagus (L13) |
...
| ↳ mata pelajaran / mapel | 科目 | (L8) |
| ↳ mata kuliah / matkul | 大学课程 | (L8) |
| ↳ mata-mata | 间谍 | orang yang tugasnya mencari informasi diam-diam (L8) |
| ↳ mata ketiga / mata batin | 第三只眼；直觉 | kemampuan melihat masa depan (L8) |
| ↳ mata panda | 黑眼圈 | muncul karena kurang tidur (L8) |
| ↳ mata uang | 货币 | mata uang Indonesia adalah rupiah (L5/L8) |
| ↳ dua sisi mata uang | 一体两面 | ulet dan keras kepala itu dua sisi mata uang (L8) |
...
| **mengerti** | 懂 | banyak kata yang tidak saya mengerti (L1/L4) |
| **menyamar** | 伪装 | mata-mata biasanya menyamar (L8) |
| ↳ pura-pura | 假装 | pura-pura jadi penjual bakso (L8) |
| **mihun/mi** | 面 | mi instan kuah (L3) |
| **monyet** | 猴子 | cinta monyet (L8/L13) |
| ↳ monkey forest | 猴林 | (L8) |
| **muka** | 脸(= wajah) | mukanya aneh-aneh (L7) |
| ↳ wajah | 脸；面容 | wajah atau pipi yang bulat (L7) |
| **mula** | 起始 | (L9) |
| ↳ mulai | 开始 | (L9) |
| **mundur** | 后退；退缩 | nggak gampang mundur (L8) |
...
| ↳ tanah air | 祖国 | (L9) |
| **nyaman** | 舒适；自在 | ada kecocokan dan rasa nyaman (L6) |
| **nyeri** | 疼痛 | (L4) |
| **obat** | 药 | saya makan obat supaya cepat sembuh (L8) |
| **operasi** | 手术 | operasi kecil (L5) |
| ↳ operasi kecil | 小手术 | (L5) |
| **pacar** | 男/女朋友 | pacar cowok (L5) |
| **padahal** | 其实；然而 | Padahal belum tentu juga (L6) |
| **pahit** | 苦 | (L4) |
| **pakaian** | 衣服 | dandanan dan cara pakaian (L11) |
| ↳ pakaian dalam | 内衣 | (L12) |
| **pandang** | 看；注视 | — |
| ↳ dipandang sebelah mata | 被轻视 | (L6/L8) |
| ↳ pemandangan | 风景 | (L7) |
| **panggung** | 舞台 | efek cahaya panggung doang (L14) |
| **parkir** | 停车 | tempat parkir (L5) |
| ↳ tempat parkir | 停车位 | (L5) |
| **paru-paru** | 肺 | kalimantan itu paru paru dunia (L10) |
| **pas** | 正好；合适 | sesuai / cocok / pas (L9) |
| **pedas** | 辣 | pedas sekali / sangat pedas (L3) |
| ↳ terpedas | 最辣 | (L3) |
...
| **penampilan** | 外表；演出 | penampilan itu penting (L8); penampilan (L14) |
| ↳ tampil / tampilkan | 上台/亮相；展示 | sudah ditampilkan (L14) |
...
| ↳ terpengaruh | 受影响 | (L10) |
| **pengen** | 想；想要(口) | pengen ikut-ikutan goyang (L11) |
...
| ↳ di pinggir kota | 城郊 | (L5) |
| **pinjam** | 借(入) | (L12) |
| **pintar / pandai** | 聪明 | pintar (L4) |
...
| **ramai** | 热闹 | memang sedang ramai dengan… (L10) |
| **rasa** | 味道；感觉 | rasa = taste (L3/L4) |
| ↳ merasa | 觉得 | saya merasa baik (L3/L5) |
| ↳ terasa | 感觉到(被动) | tetap terasa garingnya (L3) |
| ↳ perasaan | 感情 | (L4) |
...
| ↳ jadwal | 日程；行程 | (L14) |
| **rendah** | 低 | — |
| ↳ merendahkan | 贬低 | suka merendahkan dari penampilan (L6/L8) |
| ↳ direndahkan | 被贬低 | (L6) |
| **restu** | (父母的)首肯；祝福 | lebih mudah mendapatkan restu (L6/L8) |
| ↳ persetujuan | 同意；批准 | mendapatkan persetujuan (L6/L8) |
| ↳ setuju | 同意 | setuju — persetujuan (L8) |
| **robek** | 撕裂 | merobek warna birunya (L9) |
...
| ↳ terowongan | 隧道 | (L10) |
| **sambal** | 辣椒酱 | campur sambal (L11/L12) |
| **sambung** | 连接 | sambung -- nyambung (L14) |
| ↳ nyambung | 接得上；搭调 | nggak nyambung (L14) |
| **saran** | 建议 | kamu ada saran? (L8) |
| ↳ menyarankan | 建议(动词) | kamu menyarankan tempat apa? (L8) |
...
| **sembunyi** | 躲藏 | (L12) |
| ↳ tersembunyi | 隐藏的 | kejadian yang tersembunyi (L7) |
| ↳ diam-diam | 偷偷地 | mencari informasi secara diam-diam (L8) |
| **sentuh** | 触摸 | sentuh = touch (L4) |
| ↳ tersentuh | 被触动；感动 | tersentuh (L14) |
| **sengaja** | 故意 | maaf, saya tidak sengaja (L10) |
| ↳ kesengajaan | 蓄意 | ada kesengajaan dari pihak tertentu (L10) |
| **sering** | 经常 | (L1/L2) |
...
| **sia-sia** | 白费；徒劳 | ga sia-sia hari ini saya ke sana (L14) |
| ↳ menyia-nyiakan | 浪费 | (L14) |
| ↳ percuma | 白白；徒劳 | Percuma, sia-sia (L7) |
| **sibuk** | 忙 | sibuk / malas (L8/L10) |
...
| **supaya** | 以便；为了 | supaya cepat sembuh (L3/L6/L8) |
| **swalayan** | 超市 | (L2) |
| **taman** | 公园 | taman hiburan (L13) |
| **tampan / ganteng** | 帅 | (L13) |
| **tanah** | 土地 | tanah air (L9) |
| **tangani** | 处理 | menangani (L13) |
| **tari** | 舞蹈 | tari kecak bali (L8) |
| **tautan** | 链接 | (L10) |
...
_注：第 5、6、7 课的笔记本身已带完整中/英对照（L5 为 `_(中 / En)_`，L6/L7 为词根词表），本表已把其生词并入相应词根家族、去重收录。_
